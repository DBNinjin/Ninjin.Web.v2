...
>
	<div class="mx-auto max-w-md text-center">
		...
		<h1 class="mt-4 text-6xl font-bold tracking-tight text-foreground sm:text-7xl">NINJIN@EG1</h1>
		<p class="mt-4 text-muted-foreground">
			Oups, je crois que tu as trouver l'easter egg de Luneuh <br /> dénommée "Revert Logo".
		</p>
		<div class="mt-6">
			<a
				href="/"
